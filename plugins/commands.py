...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://t.me/updates_channell"),
            InlineKeyboardButton('🔔 BOT Updates 🤖', url='https://t.me/updates_channell')
            ],[
             InlineKeyboardButton('🙆🏻 All Movie & Webseries 🦾', url="https://t.me/+LwKsOLkRzb03ODBl"),
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('Join Channel', url='https://t.me/+LwKsOLkRzb03ODBl')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
